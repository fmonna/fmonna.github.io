...
pub use gen::{
    ARCHIVE, BLOG, EDUCATION, EXPERIENCE, PORTFOLIO, PROFILE, PROFILE_INTRO, PROFILE_INTRO_DRAFT,
    PUBLICATIONS, PUBLICATIONS_DRAFT, SKILLS, SKILLS_DRAFT, TALKS, TEACHING,
};
