---
# Personal / contact details + home-page intro. Source: Florence_Resume/info.tex.
# Contact fields are read by both the site (home header) and gen_cv.py (CV
# header). The `en`/`fr` block scalars below are the home-page intro prose —
# same bilingual-prose convention as skills.md / publications.md (EN is the
# source of truth; FR falls back to EN when empty).
name: Florence Monna
title:
  en: PhD
  fr: Docteur
...
en: |
  HPC architect, research engineer and engineering manager. PhD in Operations Research, following an optimization & operations research Master's from ENSTA ParisTech. My career spans CPU-GPU scheduling research, fault-tolerance and resource management software at scale, technical program management of Data, DevOps, software teams, and on-premise HPC and storage architecture. I've always liked solving problems, and turn research-grade work into production delivery.

  Explore the sections above for my experience, education, skills and publications.
fr: |
  Architecte HPC, ingénieur recherche, chef de projet technique. Docteur en Recherche Opérationelle, diplôme d'ingénieur en optimisation de l'ENSTA ParisTech. Ma carière couvre de la recherche en ordonnancement CPU-GPU, la tolérance aux pannes et des logiciels de gestion de ressource à grande échelle, la gestion de programmes techniques en Data, DevOps et ingénierie logicielle, ainsi que l'architecture de machines HPC et solutions de stockage. J'ai toujours aimé résoudre des problèmes, et transforme des travaux de recherche en livrables de production.
